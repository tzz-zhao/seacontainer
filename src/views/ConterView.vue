        ...
        <HeadersBox>
            <div>
                <img src="../assets/return.svg"
                    style="width: 17px; height: 17px; position: absolute; top: -4px; cursor: pointer" /><span
                    @click="back"
    ...
    data() {
        return {
            ...
            echartsData: [
                ...
                { title: "開閉", type: "open", data: [], xAxisData: [], pieces: { gt: 2 } },
                ...
                series: [
                    {
                        ...
                        label: {
							...
							formatter: function(param) { //拐点文字回调
								...
								if (currentValue > item.pieces.gt) {
									currentValue = currentValue + '异常';
								} else if (currentValue < item.pieces.gt) {
									currentValue = currentValue + '正常';
								}
								return currentValue;
							},
                        },
